    ...
    mounted() {
      this.table = new Tabulator("#mitabla", {
        ...
        columns: [
          ...
          { title: "Comparacion", field: "comparacion",formatter: this.operacionComparacion, sortable: true} //Uso el formater con una principal razon de uso pero sirve para dos cosas.
        ],
      ...
      descargarCSV(){
        const datosDescarga = this.filteredData.map(obj => {
          ...
          return {
            ...
            comparacion: obj.comparacion//Deberia de pillar el comparacion del metodo anterior, pero no pilla la comparacion y la operacion, solo pilla el valor de comparacion
          }
        });
        this.table.download("csv","Trabajo.csv", datosDescarga,  {bom:true});
      }

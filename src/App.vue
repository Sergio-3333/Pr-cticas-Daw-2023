  ...
  mounted() {
    ...
    methods: {
      ...
      addWidget(){
        ...
        const widget = {
          component: this.widgetIndex === 0 ? <MiGrafica></MiGrafica> : <MiTabla></MiTabla>, //Creo una constante nueva y dentro de ella, lo que hago es que si el widgetIndex es igual a 0, el primer widget.component sea MiGrafica
        };
         ...
         this.grid.addWidget('<div class="grid-stack-item widget gs-max-w="10" gs-h="10" gs-w="4""><div class="grid-stack-item-content">' + widget.component + '</div></div>'); //creo un widget con las propiedades necesarias
          }
        }, 
